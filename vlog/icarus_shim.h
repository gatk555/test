 ...
 * controls the execution of the Verilog code by blocking on a pthreads
 * condition variable until commanded to proceed by the d_cosim
 * instance, always regaining control via a VPI callback before the Verilog
 * code moves ahead of the SPICE simulation.
 */
